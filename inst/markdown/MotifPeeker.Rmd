...
out_dir_extra <- ifelse(params$save_runfiles, params$out_dir,
                       file.path(tempdir(), paste0("MotifPeeker_temp_", random_string(5))))
    ...
    function(i) {
        ...
        list(
            ...
            distance = MotifPeeker::summit_to_motif(
                ...
                out_dir = file.path(out_dir_extra, "fimo", i)
                )$distance_to_summit
        )
    },
...
#         peak <- peak_combinations[[i]]
#         motif <- motif_combinations[[i]]
#         res <- MotifPeeker::motif_enrichment(peak, motif,
#                                             genome_build = genome_build)
#         list(
#             exp_label = exp_label_combinations[i],
#             exp_type = exp_type_combinations[i],
