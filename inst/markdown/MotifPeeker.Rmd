...
#   
#     streme_results <- run_STREME(
#         result, user_motifs, motif_db, genome_build, out_dir_extra,
#         params$workers, params$meme_path, params$verbose
#     )
#     streme_results$motif_db <- motif_db
# }
...
if (!user_motif_metrics) {
    ...
    " are not provided, or only a single of dataset is provided.*\n")
} else {
    tab_header_flag <- FALSE # Print tabset header just once
